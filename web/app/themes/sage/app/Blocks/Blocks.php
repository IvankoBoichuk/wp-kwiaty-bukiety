...
class Blocks
{
    ...
    public static function multilineTitle(?string $value): string
    {
        ...
        return \sprintf(
            collect([
                '<span class="font-heading font-semibold text-[38px] leading-11.5 -mb-1.25">%s</span>',
                '<span class="text-h3 -mb-2.5">%s</span>',
                '<span class="font-heading font-medium italic text-[42px] leading-[1.2]">%s</span>',
            ])->implode(''),
            ...$lines,
        );
    }
