<div class="flex flex-col gap-8 rounded-xl bg-white px-3 py-4 shadow-[0_2px_32px_rgba(0,0,0,.08)]">
  {{-- Date dostawy --}}
  <div class="flex flex-col gap-3">
    <div class="text-green-default flex items-center gap-2">
      ...
      <span class="text-body-14">Date dostawy</span>
    </div>
    ...
    <div class="flex gap-1.5">
      ...
      >
        <span class="delivery-date-label">Inna data</span>
  ...
  <div class="flex flex-col gap-3">
    <div class="text-green-default flex items-center gap-2">
      ...
      <span class="text-body-14">Czas dostawy</span>
    </div>
  ...
  <div class="flex flex-col gap-3">
    <div class="text-green-default flex items-center gap-2">
      ...
      <span class="text-body-14">Tresc bileciku</span>
    </div>
    ...
    <textarea
      ...
      placeholder="Zostaw puste, jesli nie potrzebujesz bileciku"
      name="card-message"
    ></textarea>
  </div>
</div>
