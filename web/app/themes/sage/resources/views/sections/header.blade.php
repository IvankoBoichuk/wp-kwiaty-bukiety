...
<header class="bg-background sticky top-0 z-50 border-b border-[#426E59]">
  ...
  @endif
  <div class="fixed inset-x-0 bottom-0 z-50 w-full md:hidden">
    @if (is_product())
      @php
      ...
      <div
        ...
        x-cloak
        class="bg-background flex items-center justify-between gap-5 p-3"
      >
        <div class="flex shrink-0 items-center gap-3">
          <button
            type="button"
            class="text-green-default flex size-9 items-center justify-center rounded-xl border border-[#6D9586] transition-all disabled:opacity-50"
          ...
          <button
            type="button"
            class="text-green-default flex size-9 items-center justify-center rounded-xl border border-[#6D9586] transition-all"
